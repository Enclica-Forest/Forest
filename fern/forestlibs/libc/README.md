...
│   ├── sys/          # System headers (types.h, stat.h, etc.)
...
ssize_t write(int fd, const void *buf, size_t count) {
    ...
    // Arguments: fd, buf, count in ebx, ecx, edx
...
# Compile sources
for src in forestlibs/libc/src/*.c; do
    gcc -ffreestanding -nostdinc -Iforestlibs/libc/include \
...
1. Add the header declaration in `include/`
