...
enum syscall_number {
    ...
    // OpenGL syscalls (Fern private extension)
    SYS_GL_INIT           = 540,
    SYS_GL_BEGIN          = 541,
    SYS_GL_END            = 542,
    SYS_GL_VERTEX3F       = 543,
    ...
    SYS_GL_ENABLE         = 546,
    SYS_GL_DISABLE        = 547,
    SYS_GL_MATRIX_MODE    = 548,
    SYS_GL_LOAD_IDENTITY  = 549,
    SYS_GL_TRANSLATEF     = 550,
    SYS_GL_ROTATEF        = 551,
    SYS_GL_SCALEF         = 552,
    SYS_GL_ORTHO          = 553,
    SYS_GL_FRUSTUM        = 554,
    SYS_GL_VIEWPORT       = 555,
    SYS_GL_BIND_TEXTURE   = 556,
    SYS_GL_TEX_IMAGE_2D   = 557,
    SYS_GL_DRAW_ARRAYS    = 558,
    SYS_GL_DRAW_ELEMENTS  = 559,
    SYS_GL_PRESENT        = 560,
    SYS_GL_GET_ERROR      = 561,
    SYS_GL_PUSH_MATRIX    = 562,
    SYS_GL_POP_MATRIX     = 563,
    SYS_GL_LOAD_MATRIXF   = 564,
    SYS_GL_MULT_MATRIXF   = 565,
    SYS_GL_BLEND_FUNC     = 566,
    SYS_GL_DEPTH_FUNC     = 567,
    SYS_GL_CLEAR_COLOR    = 568,
    SYS_GL_TEX_COORD_2F   = 569,
    SYS_GL_NORMAL_3F      = 570,
    SYS_GL_VERTEX_2F      = 571,
    SYS_GL_COLOR_4F       = 572,
    SYS_GL_GEN_TEXTURES   = 573,
    SYS_GL_DELETE_TEXTURES = 574,
    SYS_GL_TEX_PARAMETERI = 575,
    SYS_GL_GEN_BUFFERS    = 576,
    SYS_GL_DELETE_BUFFERS = 577,
    SYS_GL_BIND_BUFFER    = 578,
    SYS_GL_BUFFER_DATA    = 579,
    SYS_GL_GET_STRING     = 580,
    SYS_GL_FLUSH          = 581,
    SYS_GL_FINISH         = 582,
    SYS_GL_FOGF           = 583,
    SYS_GL_FOGFV          = 584,
    SYS_GL_ALPHA_FUNC     = 585,
    SYS_GL_LIGHTF         = 586,
    SYS_GL_LIGHTFV        = 587,
    SYS_GL_MATERIALF      = 588,
    SYS_GL_MATERIALFV     = 589,
