/*
 * Enhanced Interrupt Descriptor Table (IDT) Implementation for Fern
...
/* Wrapper matching the interrupt_driven_io.h / fault_prevention.c calling
 * convention: callers pass a void* that is really an interrupt_handler_t.
 */
void interrupt_register_handler(uint8_t vector, void *handler, void *data) {
