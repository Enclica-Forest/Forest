...
# Window-manager / desktop / LeafGFX graphics options were removed with the
# Canopy desktop (Fern is kernel-only). VGA_TEXT/VSync have no dedicated
# top-level file today; guards above activate if one is added.
