...
bool pci_init(void) {
    ...
    /* Surface discovered devices to the unified driver model. This is a
       no-op when ENABLE_DRIVER_MODEL=0 (stub returns 0). */
    extern int drv_bus_enumerate_pci(void);
    drv_bus_enumerate_pci();
