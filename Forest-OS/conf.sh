...
# 150+ options across 21 categories (build + numeric tunables)
#
...
CONFIG_DB[ENABLE_FOREB_BOOTLOADER]="bool:n:none:ForeB Bootloader:Use custom ForeB bootloader instead of GRUB"
...
CONFIG_DB[ENABLE_CANOPY_DESKTOP]="bool:y:ENABLE_GRAPHICS:Canopy DE:Enable Canopy desktop environment"
...
# --- 17. Canopy DE ---
CONFIG_DB[CANOPY_DM_ENABLE]="bool:y:none:Canopy DM:Enable display manager (login screen)"
CONFIG_DB[CANOPY_DE_ENABLE]="bool:y:none:Canopy DE:Enable desktop environment"
CONFIG_DB[CANOPY_COMPOSITOR_ENABLE]="bool:y:CANOPY_DE_ENABLE:Compositor:Enable Canopy compositor"
CONFIG_DB[CANOPY_WM_ENABLE]="bool:y:CANOPY_DE_ENABLE:Window Manager:Enable Canopy window manager"
CONFIG_DB[CANOPY_PANEL_ENABLE]="bool:y:CANOPY_DE_ENABLE:Panel:Enable top panel/taskbar"
CONFIG_DB[CANOPY_DOCK_ENABLE]="bool:y:CANOPY_DE_ENABLE:Dock:Enable bottom dock/launcher"
CONFIG_DB[CANOPY_NOTIFICATIONS_ENABLE]="bool:y:CANOPY_DE_ENABLE:Notifications:Enable notification system"
CONFIG_DB[CANOPY_CONTROL_CENTER_ENABLE]="bool:y:CANOPY_DE_ENABLE:Control Center:Enable control center overlay"
CONFIG_DB[CANOPY_OVERVIEW_ENABLE]="bool:y:CANOPY_DE_ENABLE:Overview:Enable workspace overview"
CONFIG_DB[CANOPY_SLEEP_SCREEN_ENABLE]="bool:y:CANOPY_DE_ENABLE:Sleep Screen:Enable lock/sleep screen"
CONFIG_DB[CANOPY_SOUNDS_ENABLE]="bool:y:CANOPY_DE_ENABLE:Desktop Sounds:Enable desktop sound effects"
CONFIG_DB[CANOPY_A11Y_ENABLE]="bool:y:CANOPY_DE_ENABLE:Accessibility:Enable accessibility features"
CONFIG_DB[CANOPY_APP_CALC_ENABLE]="bool:y:CANOPY_DE_ENABLE:Calculator App:Build calculator application"
CONFIG_DB[CANOPY_APP_FILES_ENABLE]="bool:y:CANOPY_DE_ENABLE:File Manager:Build file manager application"
CONFIG_DB[CANOPY_APP_MONITOR_ENABLE]="bool:y:CANOPY_DE_ENABLE:Monitor App:Build system monitor application"
CONFIG_DB[CANOPY_APP_NOTES_ENABLE]="bool:y:CANOPY_DE_ENABLE:Notes App:Build notes application"
CONFIG_DB[CANOPY_APP_SETTINGS_ENABLE]="bool:y:CANOPY_DE_ENABLE:Settings App:Build settings application"
CONFIG_DB[CANOPY_APP_TERMINAL_ENABLE]="bool:y:CANOPY_DE_ENABLE:Terminal App:Build terminal application"

# --- 18. Userspace Apps ---
CONFIG_DB[USERSPACE_CORE_SHELL]="bool:y:none:Shell:Include shell and login programs"
CONFIG_DB[USERSPACE_CORE_UTILITIES]="bool:y:none:Core Utilities:Include ls, cat, cp, mv, rm, etc."
CONFIG_DB[USERSPACE_TEXT_PROCESSING]="bool:y:none:Text Tools:Include grep, sed, awk, diff, patch"
CONFIG_DB[USERSPACE_EDITORS]="bool:y:none:Editors:Include nano, vi, vim, ed"
CONFIG_DB[USERSPACE_COMPRESSION]="bool:y:none:Compression:Include gzip, bzip2, xz, tar"
CONFIG_DB[USERSPACE_PROCESS_MGMT]="bool:y:none:Process Mgmt:Include ps, top, htop, kill"
CONFIG_DB[USERSPACE_SYSTEM_INFO]="bool:y:none:System Info:Include free, df, du, uptime"
CONFIG_DB[USERSPACE_FILESYSTEM]="bool:y:none:FS Tools:Include mount, fdisk, mkfs, fsck"
CONFIG_DB[USERSPACE_USER_MGMT]="bool:y:none:User Mgmt:Include passwd, chown, chmod"
CONFIG_DB[USERSPACE_NETWORKING]="bool:y:none:Net Tools:Include ping, ifconfig, ip, netstat"
CONFIG_DB[USERSPACE_NET_TRANSFER]="bool:y:none:Net Transfer:Include curl, wget, ssh, scp, rsync"
CONFIG_DB[USERSPACE_DEV_TOOLS]="bool:y:none:Dev Tools:Include gcc, make, git, ld"
CONFIG_DB[USERSPACE_SERVICES]="bool:y:none:Services:Include systemctl, cron, journalctl"
CONFIG_DB[USERSPACE_DOCUMENTATION]="bool:y:none:Documentation:Include man, info"
CONFIG_DB[USERSPACE_DESKTOP_ENV]="bool:y:none:Desktop Env:Include canopy-de, canopydm, canopyctl"
CONFIG_DB[USERSPACE_DESKTOP_APPS]="bool:y:none:Desktop Apps:Include calculator, files, terminal, notes"
CONFIG_DB[USERSPACE_CRYPTO]="bool:n:none:Crypto Tools:Include openssl, gpg"

# --- 19. Build System ---
CONFIG_DB[GRUB_TIMEOUT]="int:5:none:GRUB Timeout:Boot menu timeout in seconds"
...
CONFIG_DB[CANOPY_DE_MAX_WINDOWS]="int:64:none:Canopy DE Max Windows:Max windows per desktop:feature"
CONFIG_DB[CANOPY_DE_FRAME_INTERVAL_MS]="int:16:none:Canopy DE Frame Interval:Compositor frame interval in ms:feature"
CONFIG_DB[CANOPY_WM_WORKSPACES]="int:4:none:Canopy WM Workspaces:Number of WM workspaces:feature"
...
"17:Canopy Desktop:CANOPY_DM_ENABLE CANOPY_DE_ENABLE CANOPY_COMPOSITOR_ENABLE CANOPY_WM_ENABLE CANOPY_PANEL_ENABLE CANOPY_DOCK_ENABLE CANOPY_NOTIFICATIONS_ENABLE CANOPY_CONTROL_CENTER_ENABLE CANOPY_OVERVIEW_ENABLE CANOPY_SLEEP_SCREEN_ENABLE CANOPY_SOUNDS_ENABLE CANOPY_A11Y_ENABLE CANOPY_APP_CALC_ENABLE CANOPY_APP_FILES_ENABLE CANOPY_APP_MONITOR_ENABLE CANOPY_APP_NOTES_ENABLE CANOPY_APP_SETTINGS_ENABLE CANOPY_APP_TERMINAL_ENABLE"
"18:Userspace Apps:USERSPACE_CORE_SHELL USERSPACE_CORE_UTILITIES USERSPACE_TEXT_PROCESSING USERSPACE_EDITORS USERSPACE_COMPRESSION USERSPACE_PROCESS_MGMT USERSPACE_SYSTEM_INFO USERSPACE_FILESYSTEM USERSPACE_USER_MGMT USERSPACE_NETWORKING USERSPACE_NET_TRANSFER USERSPACE_DEV_TOOLS USERSPACE_SERVICES USERSPACE_DOCUMENTATION USERSPACE_DESKTOP_ENV USERSPACE_DESKTOP_APPS USERSPACE_CRYPTO"
"19:Build System:GRUB_TIMEOUT QEMU_MEMORY QEMU_ENABLE_KVM QEMU_NETWORK QEMU_USB GENERATE_CHECKSUMS ENABLE_TESTING CLEAN_BEFORE_BUILD VERBOSE WERROR"
...
while true; do
    ...
    eval "dialog --title \"Forest OS Configuration v$SCRIPT_VERSION\" --menu \
        \"Configure build options for Forest OS.\\n150+ options across 21 categories.\" 30 72 32 $menu_items" 2>"$TEMPFILE" || break
