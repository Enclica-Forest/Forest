 ...
 * 
 * Linux-compatible error codes for Fern libc.
 * Uses the same values as Linux for binary compatibility.
 */
#ifndef _ERRNO_H
#define _ERRNO_H
...
/* Error number definitions (Linux x86_64 compatible) */
...
/* Error string function declarations */
