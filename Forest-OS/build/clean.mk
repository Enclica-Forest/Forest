...
# =============================================================================
# Uses OBJDIR/OUTDIR/DISTDIR from build/dirs.mk, USER_OBJDIR/USER_APP_BINARIES
# from build/userspace.mk, and OK_COLOR/NO_COLOR from build/flags.mk — all
# included earlier in the main Makefile.
#
...
.PHONY: clean clean-all clean-kernel clean-userspace maybe-clean-before-build
