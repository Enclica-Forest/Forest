...
COMMON_CFLAGS += -DCANOPY_DE_MAX_WINDOWS=$(CANOPY_DE_MAX_WINDOWS)
COMMON_CFLAGS += -DCANOPY_DE_FRAME_INTERVAL_MS=$(CANOPY_DE_FRAME_INTERVAL_MS)
COMMON_CFLAGS += -DCANOPY_WM_WORKSPACES=$(CANOPY_WM_WORKSPACES)
